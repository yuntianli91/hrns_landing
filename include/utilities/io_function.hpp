...
void readImuMotionData(string filename, vector<ImuMotionData> &imu_data){
    ...
    while(!feof(fp)){
        ...
        int ref = fscanf(fp, "%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf",
                        &time_stamp, &px, &py, &pz,
                        &qw, &qx, &qy, &qz,
                        &vx, &vy, &vz,
                        &wx, &wy, &wz,
...
void writeImuMotionData(string filename, vector<ImuMotionData> &imu_data){
    ...
    fprintf(fp, "# time_stamp[s], p_RS_R_x[m], p_RS_R_y[m], p_RS_R_z[m], q_RS_w[], q_RS_x[], q_RS_y[], q_RS_z[], v_R_x[m/s], v_R_y[m/s], v_R_z[m/s], "); 
    fprintf(fp, "gyr_S_x[rad/s], gyr_S_y[rad/s], gyr_S_z[rad/s], acc_S_x[m/s^2], acc_S_y[m/s^2], acc_S_z[m/s^2]\n"); 
